...
ac_link='$F90 -o conftest$ac_exeext $FFLAGS $LDFLAGS conftest.$ac_ext $LIBS >&AS_MESSAGE_LOG_FD'
...
# for.  Fortran 95 isn't strictly backwards-compatible with Fortran 90,
...
#
# `fort90' is a wrapper around `f2c'.
# It is believed that under HP-UX `fort90' is the name of the native
# compiler.  On some Cray systems, fort90 is a native compiler.
# frt is the Fujitsu F90 compiler.
# pgf90 and pgf90 are the Portland Group F90 and F90 compilers.
# xlf/xlf90/xlf95 are IBM (AIX) F90/F90/F95 compilers.
# lf95 is the Lahey-Fujitsu compiler.
# fl32 is the Microsoft Fortran "PowerStation" compiler.
# af90 is the Apogee F90 compiler for Intergraph hardware running CLIX.
...
AC_ARG_VAR([FFLAGS], [Fortran 90 compiler flags])dnl
_AC_ARG_VAR_LDFLAGS()dnl
AC_CHECK_TOOLS(F90,
      [m4_default([$1],
                  [f90 ifc xlf90 pgf90 epcf90 f95 fort xlf95 lf95 g95])])
...
ac_try='$F90 $FFLAGS -c conftest.$ac_ext -o conftest.$ac_objext >&AS_MESSAGE_LOG_FD'
...
# flags.
ac_save_FFLAGS=$FFLAGS
FFLAGS="$FFLAGS m4_default([$1], [$ac_cv_prog_f90_v])"
